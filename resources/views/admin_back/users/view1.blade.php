...
@section('content')
    ...
    <div class="col-sm-10">
        @if($user->profile_pic != '')<img src="{{ URL::asset('public/uploads/thumb') . '/'.  $user->profile_pic }}">@endif
    </div>
</div>
	<div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            {!! Form::select('role_id', $roles, old('role_id', $user->role_id), ['readonly','class'=>'form-control']) !!}
        </div>
    </div>
	<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::select('gender', $gender, old('gender',$user->gender), array('class'=>'form-control','readonly',)) !!}
    ...
    <div class="col-sm-10">
        {!! Form::select('status', $status, old('status',$user->status), array('class'=>'form-control','readonly')) !!}
