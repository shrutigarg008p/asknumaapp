...
<div class="form-group">
        ...
        <div class="col-sm-10">
            {!! Form::textarea('disclaimer', old('disclaimer',$blog->disclaimer), ['class'=>'form-control','rows'=>'5']) !!}
        </div>
    </div>
	<div class="form-group">
        {!! Form::label('references', 'References', ['class'=>'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
            {!! Form::textarea('references', old('references',$blog->references), ['class'=>'form-control','rows'=>'5']) !!}
        </div>
    </div>
<div class="form-group">
...
<div class="form-group">
    <div class="col-sm-10 col-sm-offset-2">
      ...
      {!! link_to_route('admin.blog.index', trans('quickadmin::templates.templates-view_edit-cancel'), null, array('class' => 'btn btn-danger')) !!}
    </div>
</div>
