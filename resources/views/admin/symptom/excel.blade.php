...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <p class=' control-label' style="text-align: left;">Please <a href="{{ URL::asset('public/uploads/symptom.xls') }}" target="_blank">click here</a> for template</p>
    </div>
</div>
<div class="form-group">
